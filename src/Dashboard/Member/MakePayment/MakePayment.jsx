...
const MakePayment = () => {
    ...
    return (
            <div>
                ...
                <h1 className='text-2xl lg:text-4xl font-bold text-blue-500'>Make Payment</h1>
            </div>

            <div className="card w-full sm:w-2/4 mx-auto bg-base-300 shadow-xl mt- 5 flex justify-center p-5 mt-5">

                <form className="grid sm:grid-cols-2 gap-2" onSubmit={handlePaymentDate}>

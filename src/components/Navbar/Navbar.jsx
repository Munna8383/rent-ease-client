...
const Navbar = () => {
  ...
  const handleLogout=()=>{
    ...
    return (
      ...
      <div className="navbar fixed top-0 z-50 px-5 sm:px-10 bg-opacity-40 max-w-7xl mx-auto">
        <div className="navbar-start">
         ...
         <h1> <Lottie  className="h-[50px] w-[80px] sm:h-[70px] sm:w-[100px]" animationData={animationData} loop={true} /></h1>
